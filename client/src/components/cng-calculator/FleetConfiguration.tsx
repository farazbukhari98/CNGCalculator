          ...
          <div className="bg-gray-50 p-4 rounded-lg dark:bg-gray-700">
            <h3 className="text-sm font-medium text-gray-700 mb-3 dark:text-gray-200">
              ...
              <MetricInfoTooltip
                ...
                description="The total estimated capital required for the project over the analysis period. Includes vehicle costs and the station cost upfront for Turnkey, lifetime LDC tariff payments for LDC Tariff, or no station cost for Public."
                calculation="Total Vehicle Investment + (Station Cost upfront if Turnkey, Annual Tariff × Time Horizon if LDC Tariff, $0 if Public)"
                affectingVariables={[
            ...
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-gray-600 dark:text-gray-300">
                ...
                <MetricInfoTooltip
                  ...
                  description="The estimated time (in years and months) it takes for the cumulative savings generated by the project to equal the cumulative investment. Investment basis differs by Station Choice."
                  calculation="Time t where Cumulative Savings(t) >= Cumulative Investment(t). Turnkey: vehicles + station upfront. LDC Tariff: vehicles + accumulating annual tariff payments. Public: vehicles only."
                  affectingVariables={[
                    "Vehicle parameters (counts, costs, MPG, lifespan)",
                    "Station configuration (type, business type, Station Choice)",
              ...
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm text-gray-600 dark:text-gray-300">
                  ...
                  <MetricInfoTooltip
                    ...
                    description="The total net profit (or loss) over the selected Time Horizon, expressed as a percentage of the total investment. Investment basis differs by Station Choice."
                ...
                <span className="text-sm text-gray-600 dark:text-gray-300">
                  ...
                  <MetricInfoTooltip
                    ...
                    affectingVariables={[
                      ...
                      "Deployment strategy timing",
                      "LDC tariff (if Station Choice = LDC Tariff)"
                    ]}
